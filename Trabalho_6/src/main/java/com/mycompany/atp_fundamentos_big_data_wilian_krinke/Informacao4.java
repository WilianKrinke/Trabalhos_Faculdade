...
public class Informacao4 {  
    ...
    public static class Implementacao4MapperAtp extends Mapper<Object, Text, Text, IntWritable>{
    ...
    public static class Implementacao4ReducerAtp extends Reducer<Text, IntWritable, Text, IntWritable>{
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException{
        ...
        String saida_pasta = "/home2/ead2022/SEM1/wilian.krinke/Documents/Tarefa-4-Semana-3";
        ...
        Job job = Job.getInstance(conf, "Implementação4.txt");
        
        job.setJarByClass(Informacao4.class);
        job.setMapperClass(Implementacao4MapperAtp.class);
        job.setReducerClass(Implementacao4ReducerAtp.class);
